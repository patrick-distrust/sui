...
<pre><code><b>const</b> <a href="../bridge/bridge.md#bridge_bridge_MESSAGE_VERSION">MESSAGE_VERSION</a>: u8 = 2;
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(
    ...
    <b>if</b> (record.<a href="../bridge/message.md#bridge_message">message</a>.message_version() == 2) {
        ...
        // <b>if</b> token_payload.timestamp is within the last 48 hours, bypass the <a href="../bridge/limiter.md#bridge_limiter">limiter</a>
