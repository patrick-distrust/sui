...
contract SuiBridgeV2Test is BridgeBaseTest {
    ...
    function testFreshMessageRespectsLimit() public {
        ...
        bytes memory payload =
            _createV2TransferPayload(bridgerA, BridgeUtils.ETH, largeAmount, block.timestamp);
    ...
    function testMessageAt48HourBoundary() public {
        ...
        uint256 boundaryTimestamp = block.timestamp - (48 * 3600);
        bytes memory payload =
    ...
    function testFreshMessageUpdatesLimiter() public {
        ...
        bytes memory payload =
            _createV2TransferPayload(bridgerA, BridgeUtils.ETH, amount, block.timestamp);
